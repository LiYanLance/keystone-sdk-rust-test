...
generate_xcframework:
	...
	mkdir -p target/sim
	lipo target/aarch64-apple-ios-sim/release/libur_registry_ffi.cdylib target/x86_64-apple-ios/release/libur_registry_ffi.cdylib -create -output target/sim/libur_registry_ffi.cdylib
	xcodebuild -create-xcframework -library target/sim/libur_registry_ffi.cdylib -headers include -library target/aarch64-apple-ios/release/libur_registry_ffi.cdylib -headers include -output target/URRegistryFFI.xcframework
